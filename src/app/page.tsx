...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      carouselItems={[
        {
          id: "1",
          imageSrc: "http://img.b2bpic.net/free-photo/female-architect-construction-site-with-level_23-2147702482.jpg",
          imageAlt: "Large commercial project",
        },
        {
          id: "2",
          imageSrc: "http://img.b2bpic.net/free-photo/world-trade-center-new-york-downtown-usa_1268-19539.jpg",
          imageAlt: "Residential construction progress",
        },
        {
          id: "3",
        ...
        {
          id: "6",
          imageSrc: "http://img.b2bpic.net/free-photo/construction-site-building_74190-1750.jpg",
          imageAlt: "Architectural finishing",
        },
      ]}
    />
  </div>
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "With over three decades of experience, Ventura Building and Construction, Inc. stands for integrity and high-quality standards in the industry.",
        "Our team of expert engineers and builders works closely with clients to bring complex architectural visions into reality.",
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          description: "Precision grading and foundation pouring using reinforced high-grade materials.",
          imageSrc: "http://img.b2bpic.net/free-photo/design-building-with-opened-windows_23-2148252778.jpg",
        },
        {
          tag: "Structure",
          title: "Structural Framing",
          subtitle: "Precision builds",
          description: "Robust structural frameworks for all residential and commercial project types.",
        ...
        },
        {
          ...
          subtitle: "Expert craft",
          description: "Meticulous interior and exterior finishes that define our signature quality.",
      ...
      metrics={[
        {
          ...
          description: "Successful builds spanning decades.",
          icon: CheckCircle,
        },
        {
          id: "m2",
        ...
        },
        {
          ...
          description: "Expertise you can rely upon.",
          icon: Award,
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "John Doe",
          handle: "@john.doe",
          testimonial: "Ventura delivered on schedule and with impeccable quality.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Sarah Smith",
          handle: "@sarah.smith",
          testimonial: "Professional team that truly cares about the final outcome.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Mike Ross",
          handle: "@mike.ross",
          testimonial: "The attention to detail in the engineering phase was amazing.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Jenny Wu",
          handle: "@jenny.wu",
          testimonial: "A reliable partner for our large-scale development project.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Tom Baker",
          handle: "@tom.baker",
          testimonial: "Exemplary work and transparent pricing every step of the way.",
          rating: 5,
